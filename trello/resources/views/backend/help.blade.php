                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="container" style="display: inline-block; background-color: #ffffff; text-align: center;">
                                <a data-fancybox="gallery" href="{{ asset('images/help/projecthome_create.jpg') }}"><img src="{{ asset('images/help/projecthome_create.jpg') }}" class="responsive imgsize borderimg"></a>
                            </div>
                            <div class="container borderimg" style="display: inline-block; margin-top: 12px; background-color: #bdc3c7; text-align: center; ">
                            ...
                            <div class="container" style="display: inline-block; background-color: #ffffff; text-align: center; margin-top: 20px;">
                                <a data-fancybox="gallery" href="{{ asset('images/help/gotowork.jpg') }}"><img src="{{ asset('images/help/gotowork.jpg') }}" class="responsive imgsize borderimg"></a>
                            </div>
                            <div class="container borderimg" style="display: inline-block; margin-top: 12px; background-color: #bdc3c7; text-align: center; ">
                            ...
                            <div class="container" style="display: inline-block; background-color: #ffffff; text-align: center; margin-top: 20px;">
                                <a data-fancybox="gallery" href="{{ asset('images/help/first_create.jpg') }}"><img src="{{ asset('images/help/first_create.jpg') }}" class="responsive imgsize borderimg"></a>
                            </div>
                            <div class="container borderimg" style="display: inline-block; margin-top: 12px; background-color: #bdc3c7; text-align: center; ">
                            ...
                            <div class="container" style="display: inline-block; background-color: #ffffff; text-align: center; margin-top: 20px;">
                                <a data-fancybox="gallery" href="{{ asset('images/help/create_user.jpg') }}"><img src="{{ asset('images/help/create_user.jpg') }}" class="responsive imgsize borderimg"></a>
                            </div>
                            <div class="container borderimg" style="display: inline-block; margin-top: 12px; background-color: #bdc3c7; text-align: center; ">
                            ...
                            <div class="container" style="display: inline-block; background-color: #ffffff; text-align: center; margin-top: 20px;">
                                <a data-fancybox="gallery" href="{{ asset('images/help/create_card.jpg') }}"><img src="{{ asset('images/help/create_card.jpg') }}" class="responsive imgsize borderimg"></a>
                            </div>
                            <div class="container borderimg" style="display: inline-block; margin-top: 12px; background-color: #bdc3c7; text-align: center; ">
                            ...
                            <div class="container" style="display: inline-block; background-color: #ffffff; text-align: center; margin-top: 20px;">
                                <a data-fancybox="gallery" href="{{ asset('images/help/creating_card_fill2.jpg') }}"><img src="{{ asset('images/help/creating_card_fill.jpg') }}" class="responsive imgsize borderimg"></a>
                            </div>
                            <div class="container borderimg" style="display: inline-block; margin-top: 12px; background-color: #bdc3c7; text-align: center; ">
