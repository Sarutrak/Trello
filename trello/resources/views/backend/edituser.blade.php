...
<div class="container">
  <div class="row justify-content-center">
    <div class="col-md-5">
      <div class="card">
        <div class="card-header"><i class="fas fa-pencil-alt" style="margin-right: 10px;"></i>Editing User......</div>
        	<div class="card-body">
                ...
                User Name : &nbsp;&nbsp;</p><input id="name" type="text" class="form-control{{ $errors->has('user_name') ? ' is-invalid' : '' }}" name="user_name" value="{{$user->user_name}}" required autofocus style="width:270px;">
